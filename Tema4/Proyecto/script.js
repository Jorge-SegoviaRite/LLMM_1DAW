...
const translations = {
    es: {
        mainTitle: 'Cuestionario Sobre la formula 1',
        subtitle: '¿Cunato crees saber de la f1?',
        welcomeTitle: 'Bienvenido al Cuestionario de Formula 1',
        instructions: 'En este cuestionario pondras a prueba tus conocimientos de F1, constará de 20 preguntas. Selecciona la respuesta correcta para cada pregunta. Al terminar, verás tu puntuación.',
        startBtn: 'Empezar',
        prevBtn: 'Anterior',
        nextBtn: 'Siguiente',
        submitBtn: 'Finalizar',
        ...
        resultsTitle: 'Resultado del Cuestionario',
        resultsScore: 'Tu puntuación:',
        resultsTime: 'Tiempo empleado:',
        restartBtn: 'Volver a Empezar',
        footerText: 'Proyecto XML - Cuestionario F1',
        questionPrefix: 'Pregunta'
    },
    en: {
        mainTitle: 'Formula 1 Quiz',
        subtitle: 'How much do you think you know about F1?',
        welcomeTitle: 'Welcome to the Formula 1 Quiz',
        instructions: 'In this quiz, you will test your knowledge of F1. It consists of 20 questions. Select the correct answer for each question. At the end, you will see your score.',
        startBtn: 'Start',
        prevBtn: 'Previous',
        nextBtn: 'Next',
        submitBtn: 'Submit',
        ...
        resultsTime: 'Time taken:',
        restartBtn: 'Restart',
        footerText: 'XML Project - F1 Quiz',
